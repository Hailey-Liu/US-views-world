...
def download_channel_videos(channel):
    ...
    videos = []
    pageToken = None
    # timeStart = '{}-01-01T00:00:00.000Z'.format(year)
    # timeEnd = '{}-12-31T23:59:59.000Z'.format(year)
    while True:
        ...
        print(video['snippet']['publishedAt'].split('T')[0])

        if int(video['snippet']['publishedAt'].split('-')[0]) < 2019:
            break
